...
class StringHelper{
    ...
    public static function filterStringWithSpecialChars($string_value){
      //$string_value = substr($string_value, 0, 8);
      //$string_value = htmlspecialchars($string_value, ENT_QUOTES | ENT_HTML5, 'UTF-8');
      //$string_value = htmlentities($string_value);
      return $string_value;
    }

    public static function replaceSpecialLetters($string_value){
        $replace = $replace = array(
            ...
            $result = str_replace(array_keys($replace), $replace, $string_value);
            return $result;
    }
}
