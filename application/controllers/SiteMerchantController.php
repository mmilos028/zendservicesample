<?php
require_once SERVICES_DIR . DS . 'apco_merchant' . DS . 'SiteMerchantManager.php';
class SiteMerchantController extends Zend_Controller_Action{
	...
	public function indexAction(){
		...
		$server->setClass('SiteMerchantManager');
