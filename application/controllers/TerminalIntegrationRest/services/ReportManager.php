...
class ReportManager {
	 ...
	 * @return mixed
	 */
	public static function playerSessions($name){
		if(!isset($name)){
	 ...
	 * @return mixed
	 */
	public static function recyclerBalanceReport($serial_number, $mac_address){
	 ...
	 * @return mixed
	 */
	public static function recyclerBalanceTopTransactionsReport($recycler_name, $mac_address){
		...
		try{
			...
			$json_message = Zend_Json::encode(
                array(
                    "status"=>OK,
                    "report"=>$reportArray,
                    "recycler_total"=>$reportResult['recycler_total'],
                    "cashbox_total"=>$reportResult['cashbox_total']
                )
            );
            exit($json_message);
		}catch(Zend_Exception $ex){
